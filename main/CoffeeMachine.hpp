...
struct FaceData {
    ...
    bool is_used;
    int coffee_ratio;   // 咖啡豆比例 (0-100)
    int water_ratio;    // 水比例 (0-100)
    int milk_ratio;     // 牛奶比例 (0-100)
};
...
public:
    ...
    lv_obj_t *_coffee_slider = nullptr;      // 咖啡豆滑块
    lv_obj_t *_water_slider = nullptr;       // 水滑块
    lv_obj_t *_milk_slider = nullptr;        // 牛奶滑块
    lv_obj_t *_coffee_label = nullptr;       // 咖啡豆数值标签
    lv_obj_t *_water_label = nullptr;        // 水数值标签
    lv_obj_t *_milk_label = nullptr;         // 牛奶数值标签
